          ...
          <div className="flex flex-wrap mx-6 md:mx-24">
            ...
            <div className="entreter-box m-0 md:m-4">
              <div className="flex w-10/12 md:w-1/2">
                <img src={quiosque} className="flex w-3/4 md:w-full pt-4 pr-2 md:pr-12 invisible md:visible" />
              </div>
            ...
            <div className="entreter-box m-0 md:m-4">
              ...
              <div className="flex w-10/12 md:w-1/2">
                <img src={salão} className="flex w-3/4 md:w-full pt-4 invisible md:visible" />
              </div>
            </div>

            <div className="entreter-box m-0 md:m-4">
              <div className="flex w-10/12 md:w-1/2 pt-0 md:pt-20">
                <img src={piscina} className="flex w-3/4 md:w-full pt-4 pr-20 invisible md:visible" />
              </div>
              <div className="w-4/10 md:w-8/12 entreter-content">
            ...
            <div className="entreter-box m-0 md:m-4">
              ...
              <div className="flex w-10/12 md:w-1/2">
                <img src={playground} className="flex w-3/4 md:w-full pt-4 invisible md:visible" />
              </div>
            </div>

            <div className="entreter-box m-0 md:m-4">
              <div className="flex w-2/12 md:w-1/2">
                <img src={quadra} className="flex w-3/4 md:w-full pt-4 invisible md:visible" />
              </div>
              <div className="w-4/10 md:w-8/12 entreter-content">
